export const yearnVaultABI = [
  ...
  { stateMutability: "nonpayable", type: "function", name: "setGovernance", inputs: [{ name: "governance", type: "address" }], outputs: [], gas: 37665 },
  { stateMutability: "nonpayable", type: "function", name: "acceptGovernance", inputs: [], outputs: [], gas: 38937 },
  { stateMutability: "nonpayable", type: "function", name: "setManagement", inputs: [{ name: "management", type: "address" }], outputs: [], gas: 39075 },
  ...
  { stateMutability: "nonpayable", type: "function", name: "setEmergencyShutdown", inputs: [{ name: "active", type: "bool" }], outputs: [], gas: 41844 },
  { stateMutability: "nonpayable", type: "function", name: "setWithdrawalQueue", inputs: [{ name: "queue", type: "address[20]" }], outputs: [], gas: 1090134 },
  {
    stateMutability: "nonpayable",
    type: "function",
    name: "transfer",
  ...
  { stateMutability: "nonpayable", type: "function", name: "addStrategyToQueue", inputs: [{ name: "strategy", type: "address" }], outputs: [], gas: 1255644 },
  {
    stateMutability: "nonpayable",
    type: "function",
